...
try {
    ...
    $sql = "SELECT
            ...
            WHERE
                DATE(appuntamento.lastModified) >= CURRENT_DATE
                AND appuntamento.lastModified <> appuntamento.creationDate
    ...
    error_log('get_modified_appointments DB error: ' . $e->getMessage());
